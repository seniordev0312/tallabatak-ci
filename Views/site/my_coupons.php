        ...
        <div class="col-lg-8 col-md-7 mb-5">
            ...
            <div class="" id="" role="">
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                    ...
                    <a href="<?= base_url()?>/add-coupon" class="btn btn-primary btn-sm">Add</a>
                    <br><br>
                ...
                <?php if ($view): $i = 1; ?>
                    <?php foreach ($view as $key => $value): ?>
                        <tr>
                         ...
                         <td><a class="btn btn-primary" href="<?= base_url('edit-coupon/'.$value['id']) ?>">Edit</a>
                            <a class="btn btn-danger" onclick="delete_coupon(<?= $value['id'] ?>)">Delete</a></td>
                        </tr>
                        <?php $i++; endforeach ?>
...
<script>
function delete_coupon(id , elem) {
