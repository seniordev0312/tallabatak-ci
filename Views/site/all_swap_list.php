...
<div class="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
  ...
  <div class="d-none d-sm-flex align-items-center flex-shrink-0 text-muted"><i class="fi-check-circle me-2"></i><span class="fs-sm mt-n1" id="total_product">There are 4 Swaps.</span></div>
  </div>
  <!-- Catalog grid-->
  ...
  function search_product(e=null , page=1)
    {
      ...
      if(e){ e.preventDefault() }
        ...
        $.ajax({
            url:"<?= base_url() ?>/Swap/fetch_data/"+page,
            method:"POST",
            dataType:"JSON",
            cache:false,
            contentType: false,
            ...
            success:function(data)
            {
               ...
               //alert('hello');
              console.log(data)
                $('#filter_data').html(data.swap_list);
