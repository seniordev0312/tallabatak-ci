...
<div class="page-content seller-verified">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Sellers Verified</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Sellers Verified</a></li>
                            <li class="breadcrumb-item active">Sellers Verified</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>/admin/incoming-seller">Incoming Seller&nbsp;<span class="badge bg-secondary"><?= ($sellers_incoming) ? count($sellers_incoming) : 0;?></span></a>
                        </li>
                        </ul>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Sellers Verified list</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div id="customerList">
