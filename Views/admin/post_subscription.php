        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Post Subscription</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Post Subscription</a></li>
                            <li class="breadcrumb-item active">Post Subscription</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Post Subscription list</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div id="customerList">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($post_subscription): $i = 1; ?>
                                            <?php foreach ($post_subscription as $key => $value): ?>
                                                <tr>
                                                 <td><?= $i; ?></td>
                                                 <td><?php //$value['title']; 
                                                 ...
                                                 ?></td>
                                                 <td><?php 
                                                 $post = $this->common_model->GetColumnName('post',array('id'=>$value['post_id']),array('title'));
                                                 ?>
                                                 <a href="<?= base_url()?>/admin/post-view/<?= $value['post_id']; ?>" target="_blank"><?php echo $post->title; ?></a>
                                                </td>
                                               <td><?php  
                                                  if($value['status'] == 0){
                  ...
                  <?php endif ?>    
                      ...
                      <div class="noresult" style="display: <?= ($post_subscription) ? 'none' : 'block' ?>">
